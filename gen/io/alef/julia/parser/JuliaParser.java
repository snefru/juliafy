...
public class JuliaParser implements PsiParser {
  ...
  public static boolean ArrayExpression(PsiBuilder b, int l) {
    ...
    if (!r) r = ArrayExpression_31(b, l + 1);
    if (!r) r = Expression(b, l + 1, -2);
  ...
  // Identifier TypeParameters
  private static boolean ArrayExpression_31(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ArrayExpression_31")) return false;
    boolean r;
  ...
  public static boolean CompactFunction(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<compact function>");
    r = Identifier(b, l + 1);
    r = r && CompactFunction_1(b, l + 1);
    r = r && Tuple(b, l + 1);
    r = r && consumeToken(b, "=");
    r = r && FunctionBody(b, l + 1);
    exit_section_(b, l, m, COMPACT_FUNCTION, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // 'module' Identifier (Statement)+ end
  ...
  /* ********************************************************** */
  // function Identifier TypeParameters?  '(' TypedVariable (',' TypedVariable)* ')' FunctionBody end
  ...
  // (',' TypedVariable)*
  private static boolean StdFunction_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "StdFunction_5")) return false;
    int c = current_position_(b);
    while (true) {
      if (!StdFunction_5_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "StdFunction_5", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // ',' TypedVariable
  private static boolean StdFunction_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "StdFunction_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && TypedVariable(b, l + 1);
  ...
  /* ********************************************************** */
  // (CompactFunction|TypedVariable|Identifier|StdFunction)*
  ...
  public static boolean TypeReference(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, "<type reference>");
    r = Identifier(b, l + 1);
  ...
  /* ********************************************************** */
  // Identifier oftype Identifier TypeParameters?
  public static boolean TypedVariable(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "TypedVariable")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<typed variable>");
    r = Identifier(b, l + 1);
    r = r && consumeToken(b, OFTYPE);
    r = r && Identifier(b, l + 1);
    r = r && TypedVariable_3(b, l + 1);
    exit_section_(b, l, m, TYPED_VARIABLE, r, false, null);
    return r;
  }

  // TypeParameters?
  private static boolean TypedVariable_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "TypedVariable_3")) return false;
    TypeParameters(b, l + 1);
    return true;
  }
  ...
  // 17: POSTFIX(AndOp)
  // 18: BINARY(LambdaExp)
  // 19: BINARY(LessThanOrEqualOp) BINARY(LessThanOp) BINARY(GreaterThanOrEqualOp) BINARY(GreaterThanOp) BINARY(IsOp) BINARY(EqualsOp) BINARY(SubtypeOp) BINARY(IsNotOp) BINARY(NotEqualOp) BINARY(ElmntGreaterThanOrEqualOp) BINARY(ElmntLessThanOrEqualOp) BINARY(ElmntGreaterThanOp) BINARY(ElmntLessThanOp) BINARY(ElmntEqualsOp) BINARY(ElmntNotEqualOp)
  // 20: BINARY(PipeOp)
  ...
  // 31: PREFIX(MacroIdentifier) ATOM(Identifier) ATOM(IntegerLiteral) ATOM(HexFloatLiteral) ATOM(HexIntegerLiteral) ATOM(CharLiteral) ATOM(BinaryLiteral) ATOM(OctalLiteral) ATOM(FloatLiteral) ATOM(ByteArrayLiteral) ATOM(VersionLiteral) ATOM(RegexLiteral) ATOM(PredefinedFloatLiteral) ATOM(PredefinedLiteral) ATOM(StringLiteral) ATOM(BooleanLiteral) ATOM(EmptyLiteral)
  // 32: N_ARY(ExpList2)
  ...
  // typealias Identifier TypeParameters? Identifier TypeParameters?
  ...
  // 'type' Identifier TypeParameters? ('<:' Identifier TypeParameters?)? TypeDefBody end
  ...
  private static boolean CompositeTypeDef_3_0(PsiBuilder b, int l) {
    ...
    r = consumeTokenSmart(b, "<:");
    r = r && Identifier(b, l + 1);
    r = r && CompositeTypeDef_3_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // TypeParameters?
  private static boolean CompositeTypeDef_3_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "CompositeTypeDef_3_0_2")) return false;
    TypeParameters(b, l + 1);
    return true;
  }

  // immutable Identifier TypeParameters? ('<:' Identifier TypeParameters?)? TypeDefBody end
  ...
  private static boolean ImmutableTypeDef_3_0(PsiBuilder b, int l) {
    ...
    r = consumeTokenSmart(b, "<:");
    r = r && Identifier(b, l + 1);
    r = r && ImmutableTypeDef_3_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // TypeParameters?
  private static boolean ImmutableTypeDef_3_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ImmutableTypeDef_3_0_2")) return false;
    TypeParameters(b, l + 1);
    return true;
  }

...
import io.alef.julia.psi.JuliaRangeOp;
import io.alef.julia.psi.JuliaVisitor;
import org.jetbrains.annotations.NotNull;

import java.util.List;

public class JuliaRangeOpImpl extends JuliaExpressionImpl implements JuliaRangeOp {
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof JuliaVisitor) ((JuliaVisitor) visitor).visitRangeOp(this);

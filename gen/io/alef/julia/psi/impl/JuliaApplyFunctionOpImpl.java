...
import io.alef.julia.psi.JuliaApplyFunctionOp;
...
public class JuliaApplyFunctionOpImpl extends JuliaExpressionImpl implements JuliaApplyFunctionOp {
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof JuliaVisitor) ((JuliaVisitor) visitor).visitApplyFunctionOp(this);

...
import io.alef.julia.psi.JuliaWhileStmt;
import org.jetbrains.annotations.NotNull;

import java.util.List;

public class JuliaWhileStmtImpl extends JuliaStatementImpl implements JuliaWhileStmt {

    public JuliaWhileStmtImpl(ASTNode node) {
        super(node);
    }

    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof JuliaVisitor) ((JuliaVisitor) visitor).visitWhileStmt(this);

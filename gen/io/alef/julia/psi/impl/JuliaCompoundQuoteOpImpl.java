...
import io.alef.julia.psi.JuliaCompoundQuoteOp;
...
public class JuliaCompoundQuoteOpImpl extends JuliaExpressionImpl implements JuliaCompoundQuoteOp {
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof JuliaVisitor) ((JuliaVisitor) visitor).visitCompoundQuoteOp(this);

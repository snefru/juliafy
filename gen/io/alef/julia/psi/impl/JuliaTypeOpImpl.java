...
import io.alef.julia.psi.JuliaTypeOp;
import io.alef.julia.psi.JuliaVisitor;
import org.jetbrains.annotations.NotNull;

import java.util.List;

public class JuliaTypeOpImpl extends JuliaExpressionImpl implements JuliaTypeOp {
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof JuliaVisitor) ((JuliaVisitor) visitor).visitTypeOp(this);

...
import io.alef.julia.psi.JuliaTypeAlias;
import io.alef.julia.psi.JuliaVisitor;
import org.jetbrains.annotations.NotNull;

import java.util.List;

public class JuliaTypeAliasImpl extends JuliaExpressionImpl implements JuliaTypeAlias {
    ...
    public void accept(@NotNull PsiElementVisitor visitor) {
        if (visitor instanceof JuliaVisitor) ((JuliaVisitor) visitor).visitTypeAlias(this);

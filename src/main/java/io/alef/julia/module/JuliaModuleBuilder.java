...
import io.alef.julia.sdk.JuliaSdkType;
...
public class JuliaModuleBuilder extends ModuleBuilder implements SourcePathsBuilder {
    ...
    public ModuleType getModuleType() {
        return JuliaModuleType.getInstance();
    }

    @Override
    public boolean isSuitableSdkType(SdkTypeId sdk) {
        return sdk instanceof JuliaSdkType;
    }

...
public class JuliaApplicationConfiguration extends LocatableConfigurationBase {
    @Nullable
    ...
    public JuliaApplicationConfiguration(String name, Project project, JuliaApplicationConfigurationType configurationType) {
    ...
    public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
        return new io.alef.julia.runner.JuliaApplicationConfigurable(getProject());
    }
...
//        }
    ...
    public RunProfileState getState(@NotNull Executor executor, @NotNull ExecutionEnvironment env) throws ExecutionException {
        ...
        return new JuliaCommandLineState(
                env,
                filePath,

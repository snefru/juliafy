...
public class JuliaSettingsStep extends SdkSettingsStep {
    ...
    public JuliaSettingsStep(@NotNull SettingsStep settingsStep, @NotNull ModuleBuilder moduleBuilder, @NotNull Condition<SdkTypeId> sdkFilter) {
        ...
        if (moduleBuilder instanceof JuliaModuleBuilder) {
    ...
    public void updateDataModel() {
        ...
        if (myModuleBuilder instanceof JuliaModuleBuilder) {
            if (myCreateSourceRoot.isSelected()) {
                ...
                if (contentEntryPath != null) {
                    ...
                    ((JuliaModuleBuilder) myModuleBuilder).setSourcePaths(Collections.singletonList(Pair.create(text, "")));
                }
            } else {
                ((JuliaModuleBuilder) myModuleBuilder).setSourcePaths(Collections.<Pair<String, String>>emptyList());
            }
        }
    }
}
